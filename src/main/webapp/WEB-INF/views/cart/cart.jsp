				...
				<section class="container">
					...
					<c:choose>
						...
						<div id="cartContent">
							...
							<div class="item">
								<div class="cart_img"><img src="assets/images/demo/shop/${cart.image }.jpg" alt="" width="60" /></div>
								<div class="product_name">${cart.name }</div>
								<a href="${pageContext.request.contextPath}/cart/cart_delete?cartNo=${cart.cartNo}" class="remove_item">X</a>
								<a href="${pageContext.request.contextPath}/pay/payPage?cartNo=${cart.cartNo}" class="remove_item">-></a>
								<div class="total_price"><span>${cart.price }</span>원</div>
