...
<div id="layout_footer" class="layout_footer">
		...
		<div class="resp_wrap">
			<ul class="menu1">
				<li class="foot_menu_d1 cs">
					<h4 class="title"><a>CS Center</a></h4>
					<ul class="list v4">
				...
				<li class="foot_menu_d2 bank">
					...
					<ul class="list v3 gray_03">
						<li>
							<p>우리은행 1002-748-541279 / <span class="gray_06" >예금주 :</span> 김모수</p>
						</li>
						<li>
							<p>신한은행 110-268-222010 / <span class="gray_06" >예금주 :</span> 박소연</p>
						</li>
					</ul>
				</li>
	...
	<div class="footer_b">
		<div class="resp_wrap">
			<ul class="menu2">
				...
				<li><a href="${pageContext.request.contextPath}/hello2" >COMPANY</a></li>
				<li><a href="${pageContext.request.contextPath}/agreement" >AGREEMENT</a></li>
				<li><a href="${pageContext.request.contextPath}/privacy" >PRIVACY POLICY</a></li>
                <li><a href="${pageContext.request.contextPath}/guide" >GUIDE</a></li>
	...
	<div class="footer_c">
		<div class="resp_wrap">
			<ul class="menu3">
				<li><span>COMPANY :</span> <span class="pcolor">(주) 검은소극장</span></li>
				<li><span>CEO :</span> <span class="pcolor">정성진 </span></li>
				...
				<li><span >PRIVACY OFFICER :</span> <span class="pcolor"> 김영민(<a class="pcolor" href="mailto:pinypine@naver.com">pinypine@naver.com</a>)</span></li>
