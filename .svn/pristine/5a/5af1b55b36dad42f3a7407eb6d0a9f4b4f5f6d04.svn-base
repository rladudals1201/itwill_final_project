...
<body>
	...
	<div id="contents" class="contents_customer" >
		...
		<li><button type="button" onclick="location.href='${pageContext.request.contextPath}/board/bquestion_list'" class="tab_tit"style="width: 20%; left: 40%;"><span>1:1문의</span></button>
						...
						<tbody>
							...
							<tr>
								...
								<td><div class="bx_textarea">
										<input type="text" class="ty2 w_full" placeholder="제목을 입력해주세요" title="문의내용 제목입력" id="qtitle" name="qtitle" value="${qtitle }">
							...
							<tr>
								...
								<td>
									<div class="bx_textarea">
										<textarea class="ty2" cols="10" rows="10" id="qcontent" name="qcontent" title="문의내용을 입력해주세요" placeholder="내용을 입력해주세요" value="${qcontent }"></textarea>
